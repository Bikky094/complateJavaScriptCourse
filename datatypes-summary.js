...
let youTubeName = "Bikkycars"

let = changeYoutubeName = youTubeName

changeYoutubeName = "NewBikkyCars"

console.log(youTubeName);
console.log(changeYoutubeName);


const userOne = {
        username: "BikkyChauhan",
        Email: "Bikky@email.com"
}

let userTwo = userOne

userTwo.username = "BikkySinghChauahn"
